...
cake1 = Cake.create(tiers: 1, title: "Birthday cake", order_id: order1.id)
...
cake2 = Cake.create(tiers: 2, title: "Anniversary Cake", order_id: order2.id)
...
cake3 = Cake.create(tiers: 1, title: "4th Birthday Cake", order_id: order2.id)
